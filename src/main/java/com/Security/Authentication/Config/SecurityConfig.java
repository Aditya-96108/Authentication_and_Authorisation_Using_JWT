...
import com.Security.Authentication.Security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    @Autowired
    private PasswordEncoder passwordEncoder; // Add this to inject your PasswordEncoder
